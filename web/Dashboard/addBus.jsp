<%-- 
    Document   : addBus
    Created on : Nov 20, 2021, 3:01:12 PM
    Author     : Students
--%>
...
<%
    ...
    if(request.getParameter("submit")!=null){
        ...
        String plate_no = request.getParameter("plate");
  ...
  try{
    ...
    con =DriverManager.getConnection("jdbc:mysql://localhost:3306/booking","root","");
          con =DriverManager.getConnection("jdbc:mysql://localhost:3306/booking","root","");
           stmt =con.prepareStatement ("insert into buses(plate_no,seats)values(?,?) ");
     
     stmt.setString(1, plate_no);
      ...
      <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
          <div class="sidebar-sticky">
            ...
            <li class="nav-item"><a href="dashboard.jsp" class="nav-link">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a href="addBus.jsp" class="nav-link active">Add Bus</a></li>
        ...
        >
          ...
          <div class="container mt-5">
            <form action="addBus.jsp" method="POST" class="dash-form">
