<%-- 
    Document   : allTickets
    Created on : Nov 20, 2021, 3:03:14 PM
    Author     : Students
--%>
    ...
    <div class="wrapper" style="background-color: #f6f5fa">
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                  ...
                  <li class="nav-item"><a href="dashboard.jsp" class="nav-link">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a href="allTickets.jsp"class="nav-link active">All Tickets</a></li>
      ...
      <%
        ...
        ResultSet rst;
          ...
          PreparedStatement ps=con.prepareStatement(  "SELECT * FROM tickets t left join users u ON u.user_id = t.user left join ligne l ON t.ligne = l.ligne_id ORDER BY ticket_time");  
