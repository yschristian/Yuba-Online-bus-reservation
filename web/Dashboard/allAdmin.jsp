<%-- 
    Document   : allAdmin
    Created on : Nov 20, 2021, 3:01:50 PM
    Author     : Students
--%>
...
<script>
  function delete_admin(admin_id) {
    ...
    if(Delete == true){
      window.location.replace('deleteAdmin.jsp?id='+ admin_id);
    }
  };
  function update_admin(admin_id) {
    let update = confirm('Do you really want to Update the admin');
    if(update == true){
      window.location.replace('updateAdmin.jsp?updateId='+ admin_id);
    }
  };
    </script>";
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                  ...
                  <li class="nav-item"><a href="dashboard.jsp" class="nav-link">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a href="allAdmin.jsp"class="nav-link active">All Admin</a></li>
      ...
      <%
        ...
        %>
                            <tr>
                              ...
                              <td><span><button class="mr-2 btn btn-danger" onclick="delete_admin(<%=rs.getString("admin_id")%>)">Delete</button></span>
                                  <span><button class ="btn btn-warning" onclick="update_admin(<%=rs.getString("admin_id")%>)">Update</button></span></td>
                            </tr>
       <%
        }
       %>
