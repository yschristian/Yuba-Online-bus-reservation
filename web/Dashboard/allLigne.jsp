<%-- 
    Document   : allLigne
    Created on : Nov 20, 2021, 3:02:47 PM
    Author     : Students
--%>
    ...
    <div class="wrapper" style="background-color: #f6f5fa">
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                  ...
                  <li class="nav-item"><a href="dashboard.jsp" class="nav-link">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a href="allLigne.jsp"class="nav-link active">All Ligne</a></li>
      ...
      <%
        ...
        ResultSet rst;
          ...
          PreparedStatement ps=con.prepareStatement(  "select * from ligne");  
