...
<script>
  function cancel_ticket(ticket_id) {
    ...
    if(cancel == true){
      window.location.replace('deleteTicket.jsp?id='+ ticket_id);
    }
  };
  function reschedule_ticket(ticket_id) {
    let update = confirm('Do you really want to Reschedule the Ticket');
    if(update == true){
      window.location.replace('updateTicket.jsp?updateId='+ ticket_id);
    }
  };
 </script>
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                  ...
                  <li class="nav-item"><a href="dashboard.jsp" class="nav-link">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a href="activeTickets.jsp" class="nav-link active">Active Tickets</a></li>
      ...
      <%
        ...
        %>
                            <tr>
                              ...
                              <td><span><button class="mr-2 btn btn-danger" onclick="cancel_ticket(<%=rs.getString("ticket_id")%>)">cancel</button></span><span><button class ="btn btn-warning" onclick="reschedule_ticket(<%=rs.getString("ticket_id")%>)">Reschedule</button></span></td>
                            </tr>
       <%
        }
       %>
