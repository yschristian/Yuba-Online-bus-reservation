<%-- 
    Document   : addLigne
    Created on : Nov 20, 2021, 3:01:23 PM
    Author     : Students
--%>
...
<%
  ...
  try{
    ...
    con =DriverManager.getConnection("jdbc:mysql://localhost:3306/booking","root","");
          con =DriverManager.getConnection("jdbc:mysql://localhost:3306/booking","root","");
           stmt =con.prepareStatement ("insert into ligne(destination,departure,price)values(?,?,?) ");
     stmt.setString(1, destination);
     stmt.setString(2, departure);
     stmt.setString(3,  price);
    
    stmt.executeUpdate();
    response.sendRedirect("allLigne.jsp");
  }
  catch(Exception e){
      ...
      <div class="row">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
          <div class="sidebar-sticky">
            ...
            <li class="nav-item"><a href="dashboard.jsp" class="nav-link">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a href="addLigne.jsp" class="nav-link active">Add Ligne</a></li>
        ...
        >
          ...
          <div class="container mt-5">
            <form action="addLigne.jsp" method="POST" class="dash-form">
